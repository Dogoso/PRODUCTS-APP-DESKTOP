...
import com.doglab.controller.CategoryController;
import com.doglab.controller.ProductController;
...
public class ViewSwing extends JFrame {
	...
	private void alterar() {
		...
		if (objetoDaLinha instanceof Integer) {
			...
			this.produtoController.update(nome, descricao, id);
		} else {
	...
	private List<Categoria> listarCategoria() {
		return this.categoriaController.list();
	}

	private void salvar() {
		if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
			Produto produto = new Produto();
			produto.setName(textoNome.getText());
			produto.setDescription(textoDescricao.getText());
			Categoria categoria = (Categoria) comboCategoria.getSelectedItem();
			produto.setCategory(categoria.getId());
